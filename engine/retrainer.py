...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loaderA, self.train_loaderB, self.image_size, self.num_classes = make_retrain_data_loader(args, args.batch_size, **kwargs)

        # 定义dataloader
        kwargs = {'run_distribute': False, 'is_train': False, 'raw': False}
        self.val_loader, _, _ = make_retrain_data_loader(args, args.batch_size, **kwargs)
